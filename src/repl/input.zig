...
const ALL_CMDS: []const CmdInfo = &.{
    ...
    .{ .cmd = "/add-dir", .desc = "Not yet implemented" },
    .{ .cmd = "/advisor", .desc = "Not yet implemented" },
    .{ .cmd = "/agents", .desc = "Not yet implemented" },
    .{ .cmd = "/alias", .desc = "Not yet implemented" },
    .{ .cmd = "/allowed-tools", .desc = "Not yet implemented" },
    .{ .cmd = "/api-key", .desc = "Not yet implemented" },
    .{ .cmd = "/approve", .desc = "Not yet implemented" },
    .{ .cmd = "/autofix", .desc = "Not yet implemented" },
    .{ .cmd = "/benchmark", .desc = "Not yet implemented" },
    .{ .cmd = "/bookmarks", .desc = "Not yet implemented" },
    .{ .cmd = "/bughunter", .desc = "Not yet implemented" },
    .{ .cmd = "/changelog", .desc = "Not yet implemented" },
    .{ .cmd = "/chat", .desc = "Not yet implemented" },
    .{ .cmd = "/color", .desc = "Not yet implemented" },
    .{ .cmd = "/cron", .desc = "Not yet implemented" },
    .{ .cmd = "/debug-tool-call", .desc = "Not yet implemented" },
    .{ .cmd = "/deny", .desc = "Not yet implemented" },
    .{ .cmd = "/desktop", .desc = "Not yet implemented" },
    .{ .cmd = "/docs", .desc = "Not yet implemented" },
    .{ .cmd = "/env", .desc = "Not yet implemented" },
    .{ .cmd = "/fast", .desc = "Not yet implemented" },
    .{ .cmd = "/feedback", .desc = "Not yet implemented" },
    .{ .cmd = "/focus", .desc = "Not yet implemented" },
    .{ .cmd = "/hooks", .desc = "Not yet implemented" },
    .{ .cmd = "/hover", .desc = "Not yet implemented" },
    .{ .cmd = "/ide", .desc = "Not yet implemented" },
    .{ .cmd = "/insights", .desc = "Not yet implemented" },
    .{ .cmd = "/keybindings", .desc = "Not yet implemented" },
    .{ .cmd = "/language", .desc = "Not yet implemented" },
    .{ .cmd = "/listen", .desc = "Not yet implemented" },
    .{ .cmd = "/macro", .desc = "Not yet implemented" },
    .{ .cmd = "/map", .desc = "Not yet implemented" },
    .{ .cmd = "/metrics", .desc = "Not yet implemented" },
    .{ .cmd = "/migrate", .desc = "Not yet implemented" },
    .{ .cmd = "/multi", .desc = "Not yet implemented" },
    .{ .cmd = "/notifications", .desc = "Not yet implemented" },
    .{ .cmd = "/perf", .desc = "Not yet implemented" },
    .{ .cmd = "/pin", .desc = "Not yet implemented" },
    .{ .cmd = "/privacy-settings", .desc = "Not yet implemented" },
    .{ .cmd = "/project", .desc = "Not yet implemented" },
    .{ .cmd = "/reasoning", .desc = "Not yet implemented" },
    .{ .cmd = "/release-notes", .desc = "Not yet implemented" },
    .{ .cmd = "/rewind", .desc = "Not yet implemented" },
    .{ .cmd = "/screenshot", .desc = "Not yet implemented" },
    .{ .cmd = "/security-review", .desc = "Not yet implemented" },
    ...
    .{ .cmd = "/team", .desc = "Not yet implemented" },
    .{ .cmd = "/telemetry", .desc = "Not yet implemented" },
    .{ .cmd = "/teleport", .desc = "Not yet implemented" },
    .{ .cmd = "/templates", .desc = "Not yet implemented" },
    .{ .cmd = "/terminal-setup", .desc = "Not yet implemented" },
    .{ .cmd = "/thinkback", .desc = "Not yet implemented" },
    .{ .cmd = "/tool-details", .desc = "Not yet implemented" },
    .{ .cmd = "/ultraplan", .desc = "Not yet implemented" },
    .{ .cmd = "/unfocus", .desc = "Not yet implemented" },
    .{ .cmd = "/unpin", .desc = "Not yet implemented" },
    .{ .cmd = "/upgrade", .desc = "Not yet implemented" },
    .{ .cmd = "/voice", .desc = "Not yet implemented" },
    .{ .cmd = "/web", .desc = "Not yet implemented" },
    .{ .cmd = "/workspace", .desc = "Not yet implemented" },
};
